...
export const ICON_GREEN = '#34C759';  // Green for active (like LINE/Messenger)
export const ICON_GRAY = '#888888';   // Gray for inactive
...
export function MicOnIcon({ size = 42, color = ICON_GREEN }) {
  return (
    <IconBase size={size} color={color}>
      ...
      <Path d="M22 31c0 6 4.9 11 10 11s10-5 10-11" strokeWidth="2.5" strokeLinecap="round" />
...
export function VideoOnIcon({ size = 42, color = ICON_GREEN }) {
  return (
    <IconBase size={size} color={color}>
      ...
      <Path d="M42 30l6-4v12l-6-4v-4Z" strokeWidth="2.5" strokeLinejoin="round" />
    </IconBase>
  );
}
...
export function SpeakerOnIcon({ size = 42, color = ICON_GREEN }) {
  return (
    <IconBase size={size} color={color}>
      <Circle cx="32" cy="32" r="26" strokeWidth="2.5" />
      <Path d="M22 28h6l8-6v20l-8-6h-6z" strokeWidth="2.5" strokeLinejoin="round" />
      <Path d="M40 28c2.5 2.5 2.5 6.5 0 9" strokeWidth="2.5" strokeLinecap="round" />
      <Path d="M44 25c4.5 4.5 4.5 12.5 0 17" strokeWidth="2.5" strokeLinecap="round" />
    </IconBase>
  );
}
